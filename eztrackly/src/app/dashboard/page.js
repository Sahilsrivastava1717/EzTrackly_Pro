...
import { useTasks, isToday, isOverdue, PRIO_COLORS, STATUS_META, friendlyDate } from "../components/TaskContext";
import AddQuickTaskDrawer from "../components/AddQuickTaskDrawer";
        ...
        <div className="grid gap-5 lg:grid-cols-2">
          ...
          <div className="rounded-2xl border border-gray-100 bg-white shadow-sm">
            <div className="flex items-center justify-between border-b border-gray-100 px-5 py-4">
              ...
              <Link href="/My-tasks" className="flex items-center gap-1 text-sm text-gray-400 hover:text-gray-600">
                View all
